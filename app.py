...
# Parámetros de los círculos
 ...
 circle1_center = (center_x - separation*0.866, center_y + 
separation*0.5)
 # Legitimidad (arriba derecha) 
 circle2_center = (center_x + separation*0.866, center_y + 
separation*0.5)
...
zorder=1)
 ...
 ax.text(circle2_center[0] + 3.2, circle2_center[1] + 2.2, 
'Legitimidad', 
 fontsize=16, fontweight='bold', ha='center')
 ...
 'discrecional': (circle2_center[0] + 1.8, circle2_center[1] + 
1.0),
